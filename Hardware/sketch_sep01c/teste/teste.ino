...
String serverPath = "/analise-expressoes/classificacoes";
...
String sendPhoto() {  
  ...
  String json = "{\"funcional_colaborador\":987234,\"imagem\":\""+ (String)converted +"\"}";
  String json2 = "{\"funcional_colaborador\":987234,\"imagem\":\"teste\"}";
  
   //POST API FAKE
   HTTPClient http;   
  
   //http.begin(*client, "https://localhost:5001/analise-expressoes/classificacoes");  
   http.begin(*client, "https://qduhdxaglpn7jvpkvxujoi3kb40xbzkh.lambda-url.us-east-2.on.aws/");  
   http.addHeader("Content-Type", "application/json");
  
   //int httpResponseCode = http.POST(json2);   //converted base64
   int httpResponseCode = http.GET();   //converted base64
